...
bool led_on = false;
if (msg->data.data[0] == 1) led_on = true;
if (msg->data.data[1] == 1) led_on = true;
if (msg->data.data[2] == 1) led_on = true;
if (msg->data.data[3] == 1) led_on = true;
if (msg->data.data[4] == 1) led_on = true;
