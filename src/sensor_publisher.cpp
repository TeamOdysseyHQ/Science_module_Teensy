...
// // =================================================
// // ============ DRILL TIMER CALLBACK ================
// // =================================================
// void drill_timer_callback(rcl_timer_t *timer, int64_t last_call_time) {
//   (void) last_call_time;
//   if (timer == NULL) return;

//   // ---- Replace with real drill + IMU data ----
//   bool drill_halted = false;
//   float distance = random(50, 400);

//   float ax = random(-20, 20) / 10.0;
//   float ay = random(-20, 20) / 10.0;
//   float az = random(80, 120) / 10.0;

//   float gx = random(-250, 250) / 10.0;
//   float gy = random(-250, 250) / 10.0;
//   float gz = random(-250, 250) / 10.0;
